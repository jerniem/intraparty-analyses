...
if csc == 1:
    ...
    pathroot = '/Users/jeremiasnieminen/Dropbox/local_speech/analysis/code/whitecollar'

partyvar = "whitecollar"
...
if empirical == 1:
    ...
    infilename1 = 'partisanship-whitecollar_Cadj_c0_partyf-cis.csv'
    infilename2 = 'partisanship-whitecollar_randlabels_Cadj_c0_partyf-cis.csv'
