...
if csc == 1:
    ...
    pathroot = '/Users/jeremiasnieminen/Dropbox/local_speech/analysis/code/uusimaa'
...
if empirical == 1:
    ...
    infilename1 = 'partisanship-uusimaa_Cadj_c0_partyf-cis.csv'
    infilename2 = 'partisanship-uusimaa_randlabels_Cadj_c0_partyf-cis.csv'
