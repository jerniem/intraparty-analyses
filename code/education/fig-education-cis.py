...
if csc == 1:
    ...
    pathroot = '/Users/jeremiasnieminen/Dropbox/local_speech/analysis/code/gender_muokatut/'
...
if empirical == 1:
    ...
    infilename1 = 'partisanship-education_Cadj_c0_partyf-cis.csv'
    infilename2 = 'partisanship-education_randlabels_Cadj_c0_partyf-cis.csv'
