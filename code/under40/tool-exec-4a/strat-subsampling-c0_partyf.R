...
outfile <- paste0('partisanship-', partyvar, suffix, '_c0_partyf-', as.character(subnr), '.csv')
...
### STRATIFIED SAMPLE: 20% of men and 20% of women
library(splitstackshape)
newdata <- stratified(full_data, c("female"), 0.2, replace=FALSE)
