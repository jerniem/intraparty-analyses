...
if csc == 1:
    ...
    pathroot = '/Users/jeremiasnieminen/Dropbox/local_speech/analysis/code/under40/'
...
if empirical == 1:
    ...
    infilename1 = 'partisanship-under40_Cadj_c0_partyf-cis.csv'
    infilename2 = 'partisanship-under40_randlabels_Cadj_c0_partyf-cis.csv'
