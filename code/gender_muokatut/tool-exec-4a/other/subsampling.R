...
##########
# Now subsampling 20 percent of data
##########
...
library(distrom)
library(Matrix)
library(tidyverse) # bc of left_join
#library(tibble)
...
outfile <- paste0('partisanship-', partyvar, suffix, '_c0-', as.character(subnr), '.csv')
...
# Changed to 20 percent 1st April 2020
