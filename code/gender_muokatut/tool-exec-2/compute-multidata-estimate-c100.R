# Call this "c99"
# Lower the psi to see impacts on partisanship measure
...
###############################################
# SET THE PENALTY COEFFICIENT HERE
# default: 1e-5

fcost <- 1e-6

print("Using fix cost of")
print(fcost)
...
saveRDS(utility_dem, file = paste0(output, "utility_dem", suffix, "_c100_", curdata))
saveRDS(utility_rep, file = paste0(output, "utility_rep", suffix, "_c100_", curdata))
saveRDS(utility, file = paste0(output, "utility", suffix, "_c100_", curdata))
saveRDS(phi, file = paste0(output, "phi", suffix, "_c100_", curdata))
