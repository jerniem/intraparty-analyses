...
saveRDS(utility_dem, file = paste0(output, "utility_dem_", suffix, "c0_", curdata))
saveRDS(utility_rep, file = paste0(output, "utility_rep_", suffix, "c0_", curdata))
saveRDS(utility, file = paste0(output, "utility_", suffix, "c0_", curdata))
saveRDS(phi, file = paste0(output, "phi_", suffix, "c0_", curdata))
