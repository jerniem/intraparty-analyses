...
# Example usage:
# Rscript subsampling.R 1 "left" 1 0 "Cadj"
...
if (length(args) != 5) {
  stop("Feed subnr, partyvar, fake indicator, penalty dummy as command line arguments")
}
...
outfile <- paste0('partisanship-', partyvar, suffix, '_c4-', as.character(subnr), '.csv')
