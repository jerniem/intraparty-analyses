...
saveRDS(utility_dem, file = paste0(output, "utility_dem", suffix, "_c1_", curdata))
saveRDS(utility_rep, file = paste0(output, "utility_rep", suffix, "_c1_", curdata))
saveRDS(utility, file = paste0(output, "utility", suffix, "_c1_", curdata))
saveRDS(phi, file = paste0(output, "phi", suffix, "_c1_", curdata))
